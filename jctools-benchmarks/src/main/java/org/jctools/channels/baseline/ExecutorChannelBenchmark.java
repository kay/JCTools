...
public class ExecutorChannelBenchmark {
    ...
    private ExecutorProxyChannel spscChannel;
    ...
    public void setupIteration() {
        ...
        this.spscChannel = new ExecutorProxyChannel(impl);
...
//        final String logFile = ExecutorChannelBenchmark.class.getSimpleName() + ".log";
        final Options opt = new OptionsBuilder()
                .include(ExecutorChannelBenchmark.class.getSimpleName() + ".*tenMixedArgs.*")
